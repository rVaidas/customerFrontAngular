...
Project contains: 
  -main table component to store data from back and.
  -one aditional component as a pop up form for adding new customer data.
Html code and styles prepared using templates from https://www.primefaces.org/ .
On app.component.ts files are place methods for loading data from backend, display all data, and add a new customer data.
